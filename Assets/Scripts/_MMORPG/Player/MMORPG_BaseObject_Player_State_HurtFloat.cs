...
public class MMORPG_BaseObject_Player_State_HurtFloat : State<MMORPG_BaseObject_Player>
{

    private static MMORPG_BaseObject_Player_State_HurtFloat instance;
    public static MMORPG_BaseObject_Player_State_HurtFloat Instance
    {
        get
        {
            if (instance == null)
            {
                instance = new MMORPG_BaseObject_Player_State_HurtFloat();
            }
            return instance;
        }
    }
